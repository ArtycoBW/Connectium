...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  // мемоизируем результат этой функции, чтобы он менялся не при каждом рендере, а только при появлении новых фигур
          ...
          {allShapes?.map((shape: any) => {
            ...
            return (
              <div
                ...
                className='group my-1 flex items-center gap-2 px-5 py-2.5 hover:cursor-pointer hover:bg-primary hover:text-primary-black'
              >
                <Image
                  src={info?.icon}
                  alt='Layer'
